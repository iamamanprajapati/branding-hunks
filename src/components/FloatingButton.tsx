  ...
  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 hidden md:flex">
      <a
        ...
        className="inline-flex bg-brand-dark hover:bg-black text-brand-cream p-3 rounded-l-lg shadow-lg transition-all duration-300 group border border-white/10 border-r-0"
